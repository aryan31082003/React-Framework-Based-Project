...
export default function About( props) {
    return (
        <>
            ...
            <div className="container my-5" style={{backgroundColor: props.mode==='light'?'white':'#010718', color: props.mode==='light'?'black':'white'}}>
                <h4  style={{display:'flex', justifyContent:'center',alignItems:"center"}}>About us</h4>
